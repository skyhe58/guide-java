...
> 💻 完整可运行代码：[ShardingDemo.java](../../../code-examples/03-data-store/database-examples/src/main/java/com/example/database/sharding/ShardingDemo.java)
...
> 💻 实战代码：[ShardingController.java](../../../code-examples/02-framework/springcloud-sharding/src/main/java/com/example/sharding/controller/ShardingController.java)
