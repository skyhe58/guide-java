...
> 💻 完整多阶段构建示例：[code-examples/06-devops/docker-k8s-examples/Dockerfile.multi-stage](https://github.com/skyhe58/guide-java/tree/main/code-examples/06-devops/docker-k8s-examples/Dockerfile.multi-stage)
> <!-- 本地路径：code-examples/06-devops/docker-k8s-examples/Dockerfile.multi-stage -->
