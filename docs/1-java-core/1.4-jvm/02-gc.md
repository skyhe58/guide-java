...
> 💻 完整可运行代码：[code-examples/01-java-core/jvm-deep-dive/.../gc/GCDemo.java](../../../code-examples/01-java-core/jvm-deep-dive/src/main/java/com/example/jvm/02-gc/GCDemo.java)
